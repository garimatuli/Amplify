...
export default class GoogleSign extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      userInfo: null,
  ...
  componentDidMount() {
    ...
    GoogleSignin.configure({
      ...
      webClientId:
        "81659617582-qf83i9r5cusno43cm6j2ksan126lagnj.apps.googleusercontent.com"
    });
  ...
  _signOut = async () => {
    ...
    try {
      ...
      console.log("It comes in error of logout");
      this.props.navigation.navigate("Home");
      console.error(error);
    }
  };
